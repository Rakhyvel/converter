...
pub const _SECIMP = @compileError("unable to translate macro: undefined identifier `dllimport`"); // C:\zig-windows-x86_64-0.11.0-dev.251+7c527c6df\lib\libc\include\any-windows-any/string.h:16:9
