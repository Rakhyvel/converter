...
//  - Surprisingly doesn't tell you where in YOUR code a segmentation fault occurs in.
...
//  - Unused locals/parameter errors and discarded function return errors get annoying when the lang server doesn't emit errors in the editor. Clutter up the error messages. (They're great error messages! Really a fault on the lang server tbh)
//
